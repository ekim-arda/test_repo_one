...
class LeftSidebar(QWidget):
    ...
    snapGridSpacingChanged = pyqtSignal(float)
    ...
    def setup_snap_settings_section(self):
        ...
        # Izgaraya snap
        self.cb_snap_grid = QCheckBox("Grid")
        self.cb_snap_grid.setChecked(False)  # Kapalı olacak
        self.cb_snap_grid.toggled.connect(self.on_snap_mode_checkboxes_toggled)
        snap_modes_layout.addWidget(self.cb_snap_grid)
        ...
        # Izgara aralığı ayarı
        snap_grid_layout = QHBoxLayout()
        snap_grid_layout.addWidget(QLabel("Grid Spacing:"))
        self.snap_grid_spacing_spinbox = QDoubleSpinBox()
        self.snap_grid_spacing_spinbox.setRange(0.1, 50.0)
        self.snap_grid_spacing_spinbox.setValue(5.0)
        self.snap_grid_spacing_spinbox.setSuffix(" NM")
        self.snap_grid_spacing_spinbox.setSingleStep(0.5)
        self.snap_grid_spacing_spinbox.valueChanged.connect(self.on_snap_grid_spacing_changed)
        snap_grid_layout.addWidget(self.snap_grid_spacing_spinbox)
        snap_layout.addLayout(snap_grid_layout)
    ...
    def on_snap_all_toggled(self, checked):
        ...
        self.cb_snap_grid.blockSignals(True)
        ...
        self.cb_snap_grid.setChecked(checked)
        ...
        self.cb_snap_grid.blockSignals(False)
    ...
    def on_snap_mode_checkboxes_toggled(self):
        ...
        if self.cb_snap_grid.isChecked():
    ...
    def on_snap_grid_spacing_changed(self, value):
        """Snap ızgara aralığı değişikliği sinyalini gönder"""
        self.snapGridSpacingChanged.emit(value)
    ...
    def set_snap_mode_checkboxes(self, mode):
        ...
        grid_checked = bool(mode & 8)          # SNAP_GRID = 8
        ...
        self.cb_snap_grid.setChecked(grid_checked)
        self.cb_snap_waypoint.setChecked(waypoint_checked)
        
        # Tümü checkbox'ının durumunu güncelle
        all_checked = all([endpoint_checked, midpoint_checked, intersection_checked, grid_checked, waypoint_checked])
        none_checked = not any([endpoint_checked, midpoint_checked, intersection_checked, grid_checked, waypoint_checked])
